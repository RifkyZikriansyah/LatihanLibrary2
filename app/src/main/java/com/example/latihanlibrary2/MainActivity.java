package com.example.latihanlibrary2;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initUI(){
        ...
        String[] permisiions = {Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.READ_EXTERNAL_STORAGE};
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            requestPermissions(permisiions, REQUEST_CODE_ASK_PERMISSIONS);
        }
    }
